...
class Popular extends StatefulWidget {
  ...
  static const routName = '/popular';

  @override
  State<Popular> createState() => _AllBooksState();
}

class _AllBooksState extends State<Popular> {
  int count = 0;
  @override
  Widget build(BuildContext context) {
    return FirestoreQueryBuilder<Post>(
      query: Post().bp(["Popular"]),
      // pageSize: 2,
      builder: (context, snapshot, _) {
        count = snapshot.docs.length;
        return Scaffold(
          appBar: AppBar(title: Text('জনপ্রিয়(${snapshot.docs.length})')),
